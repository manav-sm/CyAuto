...
When('the User adds items in the cart',function(){
...
When('the use validate the total price',function(){
    var sum = 0
...
Then('the user enters coutry name and verify the message',function(){
